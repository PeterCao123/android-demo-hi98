package com.shiji.png.droid.payment.util;
...
public class ClassUtils {
    ...
    private static final Logger logger = LoggerFactory.getLogger("ClassUtils");
    ...
    public static Set<String> getAllClasses(Context context) throws PackageManager.NameNotFoundException, IOException, InterruptedException {
        ...
        for (final String path : paths) {
            Executors.newFixedThreadPool(2).execute(() -> {
                ...
                try {
                    ...
                    logger.error("load dex file({}) error", ignore);
                } finally {
                    if (null != dexfile) {
                        try {
                            dexfile.close();
